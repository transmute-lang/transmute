...
impl Collected {
    ...
    fn finalize(self) -> Vec<ExitPoint> {
    ...
    B: BoundState,
{
    ...
    pub fn exit_points(&self, expr: ExprId) -> Vec<ExitPoint> {
...
mod tests {
    ...
    fn single_explicit_exit_point() {
        ...
        let actual = ExitPoints::new(ast.expressions(), ast.statements()).exit_points(expr);
